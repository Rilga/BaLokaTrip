...
<x-app-layout>
    ...
    <div class="video-section">
        ...
        <div class="text-container">
            ...
            <div class="nightowl-daylight" style="display: flex; align-items: center;">
                <img src="{{ asset('images/pp.jpeg') }}" alt="Profile" style="width: 48px; height: 48px; border-radius: 50%; margin-right: 1rem;">
                <div>
                    <p style="font-weight: bold;">by Abex</p>
                    <p style="font-size: 0.875rem; color: #718096;">Influencer</p>
                </div>
            </div>
        </div>
    </div>
